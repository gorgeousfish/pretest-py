...
**Requires:** ``pip install "pretest-did[data]"``
...
**Requires:** ``pip install "pretest-did[data,paper]"``
...
**Requires:** ``pip install "pretest-did[data]"`` (``progress`` extra optional for progress bars)
